# Boundary actions / внешние действия для {{repo_name}}
...
Если нужны внешние действия пользователя, оформляйте этот блок как диалоговый сценарий: цель, окно/сервис, подробные шаги, варианты с рекомендованным вариантом и fallback там, где развилка реальна, ожидаемый результат и что прислать обратно.
Если пользователь должен копировать текст, команду, handoff или repo-first instruction, выдавайте готовый fenced code block прямо в ответе. Ссылка на файл или путь в repo может быть evidence, но не заменяет copy block.
...
10. Варианты и рекомендация
11. Блоки для копирования
12. Что прислать обратно после внешнего шага
...
### GitHub repo / внешний репозиторий
...
### Обновить repo-first инструкцию
...
### Загрузить новый incoming archive
