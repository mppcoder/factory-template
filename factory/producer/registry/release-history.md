...
- `factory/producer/reference/domain-packs/openclaw-reference` и `factory/producer/extensions/workspace-packs/vscode-codex-bootstrap` закреплены как некорневые optional/reference layers
