...
echo "6. Для новой задачи запускайте Codex только через явный новый task launch: ./scripts/launch-codex-task.sh --launch-source <chatgpt-handoff|direct-task> ..."
echo "7. Не считайте новый чат или вставку handoff в случайную уже открытую сессию надежным profile/model switch."
