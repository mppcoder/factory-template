...
echo "2. При необходимости экспортируйте сценарии: ./scripts/export-sources-pack.sh ."
echo "3. Загрузите _sources-export/scenario-pack/* в Sources"
echo "4. Начните с 00-master-router.md"
