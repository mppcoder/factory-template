...
2. Где сделать
3. Точные шаги
4. Варианты и рекомендация, если есть безопасная развилка
5. Блоки для копирования
6. Ожидаемый результат
7. Что прислать обратно

Если нужны любые внешние действия пользователя, `Инструкция пользователю` оформляется как диалоговый сценарий с подробными пояснениями шагов, рекомендованным вариантом и fallback-вариантом: поясни, зачем нужен шаг, какое окно открыть, что нажать или вставить, какой вариант выбрать по умолчанию и что делать при типичной ошибке. Если нужно что-то копировать, выдай точный fenced code block прямо в ответе; не предлагай вместо этого перейти по ссылке на файл. Ссылка на файл или путь в repo может быть только дополнительным evidence, но не заменой copy block.
...
- При любых внешних действиях реализуй диалоговый сценарий с подробными пояснениями шагов, рекомендованным вариантом и fallback-вариантом, если развилка реально есть.
...
- Если предлагаешь конкретный пример текста для вставки, отправки или instruction даже вне финального внешнего шага, выдай этот пример отдельным fenced code block для копирования.
