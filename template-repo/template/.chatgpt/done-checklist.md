...
- [ ] Если в ответе есть конкретный пример текста для вставки, отправки или instruction, он выдан отдельным fenced code block для копирования
...
- [ ] Все тексты/команды/instruction/handoff, которые нужно копировать, выданы готовыми fenced code blocks
- [ ] Все предложенные конкретные примеры текста для вставки или отправки выданы готовыми fenced code blocks, даже если это не внешний шаг
