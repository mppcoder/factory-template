...
run_quick() {
  ...
  run_step "validate-worktree-manager" python3 "$ROOT/template-repo/scripts/validate-worktree-manager.py" "$ROOT"
  run_step "validate-permission-model-enforcement" python3 "$ROOT/template-repo/scripts/validate-permission-model-enforcement.py" "$ROOT"
  run_step "validate-automation-approval" python3 "$ROOT/template-repo/scripts/validate-automation-approval.py" "$ROOT"
  ...
  run_step "validate-required-human-review-policy" python3 "$ROOT/template-repo/scripts/validate-required-human-review-policy.py" "$ROOT"
  run_step "validate-auto-merge-gate" python3 "$ROOT/template-repo/scripts/validate-auto-merge-gate.py" "$ROOT"
  run_step "validate-production-deploy-gate" python3 "$ROOT/template-repo/scripts/validate-production-deploy-gate.py" "$ROOT"
  run_step "validate-security-issue-gate" python3 "$ROOT/template-repo/scripts/validate-security-issue-gate.py" "$ROOT"
  run_step "validate-public-submit-gate" python3 "$ROOT/template-repo/scripts/validate-public-submit-gate.py" "$ROOT"
