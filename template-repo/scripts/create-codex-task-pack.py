...
- [ ] fenced code block для копирования
...
Если нужны внешние действия пользователя, `Инструкция пользователю` должна быть оформлена как диалоговый сценарий с подробными пояснениями шагов, рекомендованным вариантом и fallback-вариантом. Если нужно что-то копировать, выдай fenced code block и не предлагай вместо этого перейти по ссылке на файл.
...
- `Инструкция пользователю` должна быть оформлена как диалоговый сценарий с подробными пояснениями шагов, рекомендованным вариантом и fallback-вариантом.
- Если пользователю нужно копировать текст, команду, URL, instruction или handoff, выдай точный fenced code block для копирования прямо в финальном ответе; не предлагай вместо этого перейти по ссылке на файл.
