...
- если route изменился, один цельный ready-to-copy handoff block для нового Codex task как канонический вариант;
...
- `Рекомендуемый путь: новый Codex task/chat` — если route отличается;
