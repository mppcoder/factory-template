...
- текст generator вынесен в шаблон `factory/producer/ops/templates/factory-template-boundary-actions.template.md`
...
- feedback из working project можно перенести в `reports/factory-feedback/incoming-learnings/`
