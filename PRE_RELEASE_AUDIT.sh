...
for f in README.md ENTRY_MODES.md POST_UNZIP_SETUP.sh MATRIX_TEST.sh RELEASE_BUILD.sh VERSION_SYNC_CHECK.sh VALIDATE_FACTORY_TEMPLATE_OPS.sh VALIDATE_FACTORY_FEEDBACK.sh DETECT_FACTORY_TEMPLATE_PHASE.sh PHASE_DETECTION_TEST.sh RELEASE_CHECKLIST.md VERIFY_SUMMARY.md RELEASE_NOTES.md RELEASE_NOTE_TEMPLATE.md COMMIT_MESSAGE_GUIDE.md factory-template-ops-policy.yaml .env.example .chatgpt/handoff-response.md docs/releases/release-scorecard.yaml factory_template_only_pack/templates/factory-template-boundary-actions.template.md registry/factory-versions.md registry/projects-created.md FACTORY_MANIFEST.yaml template-repo/TEMPLATE_MANIFEST.yaml template-repo/codex-routing.yaml template-repo/template/.env.example template-repo/template/.chatgpt/direct-task-response.md template-repo/scripts/validate-codex-task-pack.py template-repo/scripts/validate-codex-routing.py template-repo/scripts/validate-handoff-response-format.py template-repo/scripts/resolve-codex-task-route.py template-repo/scripts/bootstrap-codex-task.py template-repo/scripts/launch-codex-task.sh template-repo/scripts/verified-sync.py template-repo/scripts/execute-release-decision.py template-repo/scripts/validate-verified-sync-prereqs.py template-repo/scripts/validate-release-decision.py template-repo/scripts/validate-release-notes-source.py template-repo/scripts/validate-release-report.py template-repo/scripts/validate-release-scorecard.py meta-template-project/RELEASE_NOTES.md VERIFIED_SYNC.sh EXECUTE_RELEASE_DECISION.sh VALIDATE_VERIFIED_SYNC_PREREQS.sh VALIDATE_RELEASE_DECISION.sh VALIDATE_RELEASE_NOTES_SOURCE.sh VALIDATE_RELEASE_REPORT.sh; do check_exists "$f"; done
for f in UPGRADE_SUMMARY.md onboarding-smoke/run-novice-e2e.sh onboarding-smoke/ACCEPTANCE_REPORT.md workspace-packs/factory-ops/upgrade-report.py workspace-packs/factory-ops/rollback-template-patch.sh reports/bugs/2026-04-23-factory-ops-utcnow-warning.md; do check_exists "$f"; done
