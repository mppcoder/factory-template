...
for f in README.md ENTRY_MODES.md POST_UNZIP_SETUP.sh MATRIX_TEST.sh RELEASE_BUILD.sh VERSION_SYNC_CHECK.sh VALIDATE_FACTORY_TEMPLATE_OPS.sh VALIDATE_FACTORY_FEEDBACK.sh DETECT_FACTORY_TEMPLATE_PHASE.sh RELEASE_CHECKLIST.md VERIFY_SUMMARY.md RELEASE_NOTE_TEMPLATE.md COMMIT_MESSAGE_GUIDE.md factory-template-ops-policy.yaml factory_template_only_pack/templates/factory-template-boundary-actions.template.md registry/factory-versions.md registry/projects-created.md FACTORY_MANIFEST.yaml template-repo/TEMPLATE_MANIFEST.yaml template-repo/scripts/validate-codex-task-pack.sh meta-template-project/RELEASE_NOTES.md; do check_exists "$f"; done
