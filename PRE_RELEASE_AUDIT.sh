...
for f in README.md POST_UNZIP_SETUP.sh MATRIX_TEST.sh RELEASE_BUILD.sh VERSION_SYNC_CHECK.sh VALIDATE_FACTORY_TEMPLATE_OPS.sh RELEASE_CHECKLIST.md VERIFY_SUMMARY.md RELEASE_NOTE_TEMPLATE.md factory-template-ops-policy.yaml factory_template_only_pack/templates/factory-template-boundary-actions.template.md registry/factory-versions.md registry/projects-created.md FACTORY_MANIFEST.yaml template-repo/TEMPLATE_MANIFEST.yaml meta-template-project/RELEASE_NOTES.md; do check_exists "$f"; done
