...
- `factory/producer/reference/examples/example-change-small-fix`
- `factory/producer/reference/examples/example-change-brownfield-audit`
- `factory/producer/reference/examples/example-change-end-to-end`

## Шаги воспроизведения
1. Запустить `python3 template-repo/scripts/check-dod.py factory/producer/reference/examples/example-change-small-fix`.
...
## Evidence
- [PROJECT] `python3 template-repo/scripts/check-dod.py factory/producer/reference/examples/example-change-small-fix` -> `DOD НЕ ПРОЙДЕН` и сообщение `при настроенном origin требуется .factory-runtime/reports/verified-sync-report.yaml`.
- [PROJECT] `git -C factory/producer/reference/examples/example-change-small-fix rev-parse --show-toplevel` возвращает `/projects/factory-template`, а не путь самого fixture.
