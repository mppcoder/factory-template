...
|---|---:|---|---|
| `M25-01` time-to-first-success | `<= 25` minutes | `onboarding-smoke/ACCEPTANCE_REPORT.md` now records duration per scenario. | Pass |
| `M25-02` first-run completion rate | `>= 92%` | `reports/release/2.5-controlled-pilot-checklist.md` records `9/9`, `100%`. | Pass |
| `M25-03` manual intervention count | `<= 1` | `onboarding-smoke/ACCEPTANCE_REPORT.md` records `0` interventions. | Pass |
...
- Added timed beginner first-success runs in `onboarding-smoke/ACCEPTANCE_REPORT.md`.
