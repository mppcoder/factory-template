...
- model availability auto-check добавлен в executable routing layer: `codex-model-routing.yaml`, `check-codex-model-catalog.py`, live `codex debug models` validation, proposal-only promotion policy and strict/unavailable validator modes
