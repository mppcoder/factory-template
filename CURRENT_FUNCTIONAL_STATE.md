...
- field pilot roadmap продвинут до partial evidence: FP-01 greenfield выполнен на `https://github.com/mppcoder/greenfield-test` latest commit `cca68d5`, FP-02 brownfield without repo выполнен на `https://github.com/mppcoder/openclaw-brownfield` latest commit `7b3d1a4`, FP-03 brownfield with repo выполнен на `https://github.com/mppcoder/openclaw-brownfield` latest audit commit `3c026fd`; FP-04/FP-05 остаются pending до real downstream sync cycles
...
- текущий field evidence status: `partial-field-evidence` (`FP-01`, `FP-02` и `FP-03` passed, `3/5`)
...
- field pilot scenarios FP-04/FP-05: downstream sync cycle 1, downstream sync cycle 2
