...
- граница evidence: `2.5.3 Package Ready` означает, что repo-controlled GA evidence линии `2.5` сохраняется, а patch release добавляет проверяемый Windows beginner bootstrapper artifact contract
...
- `2.5.3` scope: Windows beginner bootstrapper UX release with PowerShell 7 recommendation, safe default prompt values, archive fallback and npm-unsupported boundary.
