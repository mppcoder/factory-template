...
- граница evidence: `2.5.2 Package Ready` означает, что repo-controlled GA evidence линии `2.5` сохраняется, а patch release добавляет проверяемый Windows beginner bootstrapper artifact contract
...
- `2.5.2` scope: downloadable release artifact with Windows beginner bootstrapper MVP, GitHub-first install positioning, archive fallback and npm-unsupported boundary.
