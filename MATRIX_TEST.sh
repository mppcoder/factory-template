...
assert_pass 'downstream-sync-v3' 'multi-cycle-sync-proof' "$ROOT/factory/producer/extensions/workspace-packs/factory-ops/validate-downstream-multi-cycle-sync.py" "$ROOT" --report-output "$SBASE/downstream-multi-cycle-sync-report.md"
